...
import cv2
# 数据集类别名
names = ["high risk FOD", "medium risk FOD", "low risk FOD", "non-FOD"]  # class names
# yolov5s网络中的三个detect层
target_layers = ['model_17_cv3_act', 'model_20_cv3_act', 'model_23_cv3_act']

# Arguments
parser = argparse.ArgumentParser()
parser.add_argument('--model-path', type=str, default="runs/train/exp15/weights/last.pt", help='Path to the model')
parser.add_argument('--img-path', type=str, default='CAMin/', help='input image path')
parser.add_argument('--output-dir', type=str, default='out/', help='output dir')
